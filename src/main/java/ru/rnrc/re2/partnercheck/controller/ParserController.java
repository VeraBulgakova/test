...
public class ParserController {
    ...
    public ResponseEntity<List<ResponseDTO>> checkPartners(@RequestParam("file") MultipartFile file, @Parameter(
            description = "Дата для проверки в формате dd.MM.yyyy",
            required = true)
    @DateTimeFormat(pattern = "dd.MM.yyyy") LocalDate checkDate) throws JAXBException {
